      ...
      <div className="w-full flex flex-col lg:flex-row gap-16 lg:gap-24">
        ...
        >
          <div className="aspect-[3/4] relative border border-white/[0.06] overflow-hidden">
            <img
              src="https://images.unsplash.com/photo-1649649089599-59782dff8d04?crop=entropy&cs=tinysrgb&fit=max&fm=webp&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzaWxpY29uJTIwY2hpcCUyMG1hY3JvfGVufDF8fHx8MTc3MjkwNTU1MHww&ixlib=rb-4.1.0&q=75&w=720"

...
summary: ARM Cortex-M room scanner that drives a stepper motor and a VL53L1X time-of-flight sensor in a coordinated sweep, streams distances over UART, and renders the result as a 3D point cloud in Open3D.
